...
export const metadata: Metadata = {
  title: 'Dashboard',
  description: 'Manage your shared 3D models',
}
    ...
    <div className="flex flex-col md:flex-row min-h-screen relative">
      ...
      >
        ...
        <nav className="flex-1 px-3 space-y-1">
          <NavItem href="/dashboard" icon={LayoutGrid} label="My projects" />
          <NavItem href="/dashboard/upload" icon={Upload} label="New upload" />
        </nav>
